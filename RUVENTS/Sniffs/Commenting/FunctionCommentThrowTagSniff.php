...
namespace RUVENTS\Sniffs\Commenting;
            ...
            */
            ...
            if ($tokens[$nextToken]['code'] === T_NEW) {
                ...
                if ($currException !== false) {
                    ...
                    $thrownException = $endException === false
                        ? $tokens[$currException]['content']
                        : $phpcsFile->getTokensAsString($currException, ($endException - $currException));

                    // Определяем полное имя класса исключения.
                    $thrownExceptions[] = NamespaceHelper::resolveClassName($phpcsFile, $thrownException, $currPos);
                }//end if
